...
using TickTest.Droid.Services;
using Plugin.Tick;

namespace TickTest.Droid
{
    [Activity(Label = "LightFormsTemplate", Icon = "@mipmap/ic_launcher", Theme = "@style/MainTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
